...
# ── Database stats (served by /stats, generated by scripts/compute_stats.py) ──


class SubjectCount(BaseModel):
    """A subject (keyword) and how many datasets carry it within a repository."""
...
class RepositoryStats(BaseModel):
    """Harvested-record stats for a single repository."""

    code: str
    name: str
    record_count: int
    datasets: int
    endpoints_with_records: int
    synced_to_opensearch: int
    latest_record_datestamp: datetime | None = None
